...
contract EthPriceOracle {
    ...
    mapping(uint256 => Response[]) private requestIdToResponse;
    ...
    event GetLatestEthPriceEvent(address indexed callerAddress, uint256 id);
    event SetLatestEthPriceEvent(
        uint256 ethPrice,
        address indexed callerAddress
    );
    event AddOracleEvent(address indexed oracleAddress);
    event RemoveOracleEvent(address indexed oracleAddress);
